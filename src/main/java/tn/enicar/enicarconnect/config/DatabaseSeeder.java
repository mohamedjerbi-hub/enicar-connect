...
/**
 * Pré-remplit PostgreSQL avec un jeu de données cohérent pour la soutenance
 * ENICAR Connect.
 * Activé uniquement avec le profil {@code postgres} lorsque aucun utilisateur
 * n'existe encore.
 */
@Component
@Profile("postgres")
...
public class DatabaseSeeder implements CommandLineRunner {
        ...
        public void run(String... args) {
                if (userRepository.count() > 0) {
                        log.info("Base PostgreSQL déjà peuplée ({} utilisateur(s)), seed démo ignoré.",
        ...
        private void seedAll() {
                ...
                User mohamedJerbi = persistUser(encPwd, Role.STUDENT, "Mohamed", "Jerbi",
                                "mohamed.jerbi@enicar.ucar.tn",
                ...
                User mohamedBabou = persistUser(encPwd, Role.STUDENT, "Mohamed", "Babou",
                                "mohamed.babou@enicar.ucar.tn",
                                "Équipe projet ENICAR Connect (infra & données).",
                                "Génie Informatique", "2ème année", "2ème Info Groupe C",
                                skills("Docker", "CI/CD", "Spring Data JPA", "Git"));

                User mohamedDhiaAbidi = persistUser(encPwd, Role.STUDENT, "Mohamed Dhia Islem", "Abidi",
                                "mohamed-dhia.abidi@enicar.ucar.tn",
                                "Équipe projet ENICAR Connect (qualité / transversalité).",
                                "Génie Informatique", "2ème année", "2ème Info Groupe C",
                                skills("PostgreSQL", "Java", "Spring AOP"));

                User sarahMezzi = persistUser(encPwd, Role.STUDENT, "Sarah", "Mezzi",
                                "sarah.mezzi@mecatronique.enicar.ucar.tn",
                                "Étudiante en Mécatronique.", "Mécatronique", "3ème année", null,
                                skills("PLC", "Capteurs", "Electronique analogique"));

                User hakimDrira = persistUser(encPwd, Role.STUDENT, "Hakim", "Drira",
                                "hakim.drira@mecatronique.enicar.ucar.tn",
                                "Club robotique.", "Mécatronique", "3ème année", null,
                                skills("Arduino", "Mécatronique", "Asservissement"));

                User karimMansour = persistUser(encPwd, Role.STUDENT, "Karim", "Mansour",
                                "karim.mansour@gm.enicar.ucar.tn",
                                "Projets conception mécanique.", "Génie Mécanique", "3ème année", null,
                                skills("Fabrication mécanique", "Dessin industriel"));

                User nourBenSalah = persistUser(encPwd, Role.STUDENT, "Nour El Houda", "Ben Salah",
                                "nour.bensalah@gm.enicar.ucar.tn",
                                "Laboratoires matériaux.", "Génie Mécanique", "3ème année", null,
                                skills("Matériaux", "Essais mécaniques"));

                User alumniVermeg = persistUser(encPwd, Role.ALUMNI, "Amine", "Khelifi",
                                "amine.khelifi@alumni.vermeg.tn",
                                "Ingénieur logiciels chez Vermeg.", "Génie Informatique", null, null,
                                skills("Java", "Spring Boot", "Angular"));

                User alumniSopra = persistUser(encPwd, Role.ALUMNI, "Layla", "Zarrouk",
                                "layla.zarrouk@alumni.soprahr.tn",
                                "Consultante RH & ATS chez Sopra HR.", "Génie Informatique", null, null,
                                skills("Recrutement", "Talent acquisition"));

                User direction = persistUser(encPwd, Role.DIRECTION, "Direction", "ENICAR", "direction@enicar.ucar.tn",
                                "Direction de l'ENI Carthage — Services Administratifs.", null, null, null,
                                skills("Gestion", "Administration", "Gouvernance"));
                ...
                AppGroup groupeClasseC = persistGroup(mohamedJerbi, "2ème Info Groupe C",
                                "Promotion 2ème année Info — Groupe de projet soutenance.", GroupType.PROMOTION,
                                GroupKind.CUSTOM);
